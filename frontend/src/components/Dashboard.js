...
import DelayAppointments from './DelayAppointments.js'
...
function Copyright() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      {'Copyright © '}
      <Link color="inherit" href="https://github.com/irinelenache">
          ...
          <Grid container spacing={3}>
            ...
            { reqGetUser() === "Admin" && (
              <Route exact path="/delayAppointments">
                  <DelayAppointments></DelayAppointments>
              </Route>
            )}
          </Grid>
          <Box pt={4}>
